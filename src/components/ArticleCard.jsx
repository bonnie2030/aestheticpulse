    ...
    <div className="relative">
      <article className="futuristic-card relative grid grid-cols-3 items-stretch overflow-hidden">
        ...
        <div className="col-span-2 p-6 flex flex-col justify-center">
          ...
          <h3 className="text-2xl font-extrabold mt-2 text-gray-900 leading-tight">{a.title}</h3>
          <p className="text-gray-600 mt-3 line-clamp-3">{a.introduction && a.introduction.trim()? a.introduction : a.excerpt}</p>
          <div className="mt-6">
