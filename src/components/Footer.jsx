      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="mt-10 pt-6 border-t flex flex-col md:flex-row gap-3 md:items-center md:justify-between text-sm text-gray-500">
          <a
            ...
            className="hidden md:inline-flex items-center justify-center rounded-full border border-gray-200 bg-gray-50 px-4 py-2 font-semibold text-gray-700 shadow-sm transition hover:border-pink-300 hover:text-pink-600 hover:bg-pink-50"
          >
            Admin Login
          </a>
