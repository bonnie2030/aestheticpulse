    ...
    <header className="bg-white border-b">
      <div className="w-full px-4 sm:px-6 py-4 md:py-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 md:gap-6">
          ...
          <nav className="order-3 lg:order-2 w-full lg:w-auto flex flex-wrap justify-center lg:justify-center gap-3 md:gap-6 text-sm text-gray-600 text-center">
          ...
          <div className="order-2 lg:order-3 flex items-center justify-end w-full lg:w-auto">
