...
export default function Header(){
  ...
  return (
    <header className="bg-white border-b">
      <div className="w-full px-6 py-6 md:py-10 space-y-5 md:space-y-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 md:gap-6">
          ...
          <a href="https://pin.it/2G044qZNh" target="_blank" rel="noreferrer" className="inline-flex items-center text-sm lg:text-base font-semibold text-pink-600 self-start lg:self-auto">
